---
title: "XIAO ESP32C6 Zigbee Quick Start Guide (Arduino) | Seeed Studio Wiki"
source: "https://wiki.seeedstudio.com/xiao_esp32c6_zigbee_arduino/"
tags:
  - "clippings"
---
## Overview​
...
![](https://files.seeedstudio.com/wiki/xiaoc6_zigbee/0.png)
...
1. [Zigbee Overview](https://wiki.seeedstudio.com/xiao_esp32c6_zigbee_arduino/#zigbee_overview): Understand the Zigbee protocol and its network structure.
2. [Zigbee Arduino Examples](https://wiki.seeedstudio.com/xiao_esp32c6_zigbee_arduino/#examples): Implement Zigbee examples like light bulbs and switches on the ESP32-C6.
...
1. **Device Types** Zigbee devices (e.g., switches, sensors, lights) are pre-defined with specific behaviors, grouped into functional **Clusters**.
2. **Clusters** Clusters are logical groupings of:
...
3. **Attributes & Commands** Attributes store device data (e.g., state, configuration), while commands initiate actions.

![](https://files.seeedstudio.com/wiki/xiaoc6_zigbee/datamodel.png)
...
![](https://mermaid.ink/svg/pako:eNptkcEOgjAQRH9lsydI5CDcuIo_oJ5MLxu6AlG6pLYmxvjvVlFSgj3NtG9nmvaBtWjGEgGgsTS0cKiUgXFtRKzuDDmxSRKZNIUsy2An3rFdJ8koYJ2m_0YjNp_YPGK_OR9ua3TFt67mEBs0jGYWHeOjLqbYYsHlMff3bKrMZ5XLGxZzvJjhoRlX2LPtqdPhPR_vYYWu5Z4VlkFqsmeFyjwDR97J_m5qLJ31vEIrvml_xg-aHFcdhQ_psTzR5Rp2BzJHkZ9_vgDkroUg)
- **Key Features**:
...
![](https://mermaid.ink/svg/pako:eNqF0MEKwjAMBuBXCTmt4A5OT7s6X0A9SS9hjW7omlFbQcR3tzqVFQV7yl--_IdcsRbDWCIA7B31DWwqbWF4CxFnWkteXJaNglKQ5zmsJHh20ywbBpgq9Wt1ZIuPLUb21fN0S2sqPrc1x9o4wxCS6p-8SPh3e5HyWcJn__g84XOlcIIdu45aE093fSxr9A13rLGMoyF30KjtLToKXtYXW2PpXeAJOgn7BssdHU8xhd6Q56qlePzu89uT3Yq88-0OO1R_gA)
- **Key Features**:
...
![](https://mermaid.ink/svg/pako:eNqNkMEKwjAMhl8l5LTCdth269X5BHqSXsIat6JtR20FGXt3K0Nx4MGc_i_kCyEz9l4zSgSAIdA0wrFTDtbaeR-0cRR9KIovEAKqqoK90x3fTc91UeQMK0AtxK8NW6XZKM0_SrtRWiGwRMvBktH5_vm1QGEc2bJCmaOmcFGo3JLnKEV_eLgeZQyJSww-DSPKM11vmdKkKXJnKH_AfroTuZP3b16etDldgQ)
- **Key Features**:
...
### Example 1: Light Bulb and Light Switch​
...
##### `setup()` Function[​](https://wiki.seeedstudio.com/xiao_esp32c6_zigbee_arduino/#setup-function "Direct link to setup-function")
...
##### `loop()` Function[​](https://wiki.seeedstudio.com/xiao_esp32c6_zigbee_arduino/#loop-function "Direct link to loop-function")
...
#### Demonstration​
![](https://www.youtube.com/watch?v=Z2NROYx7hcQ)
