---
title: "Bluetooth Usage | Seeed Studio Wiki"
source: "https://wiki.seeedstudio.com/xiao_esp32c6_bluetooth/"
tags:
  - "clippings"
---
...
- [Some fundamental concepts](https://wiki.seeedstudio.com/xiao_esp32c6_bluetooth/#some-fundamental-concepts) -- We will first get to know some concepts that may be used frequently in BLE in order to help us understand the execution process and thinking of BLE programs.
- [BLE Scanner](https://wiki.seeedstudio.com/xiao_esp32c6_bluetooth/#ble-scanner) -- This section will explain how to search for nearby Bluetooth devices and print them out in the serial monitor.
- [BLE server/client](https://wiki.seeedstudio.com/xiao_esp32c6_bluetooth/#ble-serverclient) -- This section will explain how to use XIAO ESP32C6 as Server and Client to send and receive specified data messages. It will also use to receive or send messages from the phone to XIAO.
- [BLE Sensor Data Exchange](https://wiki.seeedstudio.com/xiao_esp32c6_bluetooth/#ble-sensor-data-exchange) -- This is the last section of the full tutorial where we will go through a sensor example to explain how to send the sensor data through BLE.
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/ble.png)
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/52.png)
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/62.png)
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/50.png)
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/51.png)
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/54.png)
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/60.png)
...
Then, you create a BLE device called “XIAO\_ESP32C6”. You can change this name to whatever you like. In the following line, you set the BLE device as a server. After that, you create a service for the BLE server with the UUID defined earlier.
...
| --- | --- | --- |
| ![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32C6/img/xiaoc6.jpg) | ![](https://files.seeedstudio.com/wiki/Seeeduino-XIAO-Expansion-Board/Update_pic/zheng1.jpg) | ![](https://files.seeedstudio.com/wiki/Grove-Digital_Light_Sensor/img/hardware%20overview.jpg) |
| [**Get One Now 🖱️**](https://www.seeedstudio.com/Seeed-Studio-XIAO-ESP32C6-p-5884.html) | [**Get One Now 🖱️**](https://www.seeedstudio.com/Seeeduino-XIAO-Expansion-board-p-4746.html) | [**Get One Now 🖱️**](https://www.seeedstudio.com/Grove-Digital-Light-Sensor-TSL2561.html) |
...
[**Download the Libraries**](https://github.com/olikraus/U8g2_Arduino)

  

- **Library of Grove - Digital Light Sensor - TSL2561**:

[**Download the Libraries**](https://github.com/Seeed-Studio/Grove_Digital_Light_Sensor)
...
After uploading the program for one of the XIAO, if the program runs smoothly, then you can take out your phone and use the nRF Connect APP to search for the Bluetooth device named **XIAOESP32C6\_BLE**, connect it, and click the button shown below, you will receive the sensor data information.

![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/63.jpg)
...
void setup() {
  ...
  pCharacteristic->registerForNotify( {
...
![](https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/img/65.gif)
...
The second parameter of the `createCharacteristic()` function is to set the properties. Note that here we need to set it to **PROPERTY\_NOTIFY** to ensure that the data is sent continuously.
